 ...
 * gmalloc(int), new with gnew(int), and call gclear() before any point at which the program
 ...
 * If they desire to use delete they should use gdelete.
 * This is a C++ extension to garbage.h for C. 
***************************************************************************/
#ifndef GARBAGECPP
#define GARBAGECPP
